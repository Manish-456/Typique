...
const Trending = () => {
  ...
  if (blogs?.length > 0) {
    content = (
      <div className="p-4 mt-10 font-bold text-xl ">
          ...
          <div className="right-side md:mt-0 mt-4">
            ...
            <div className="flex justify-between p-4">
              <div className={iconDivClasses}>
                <Link
                  target="_blank"
                  to={`https://www.facebook.com/profile.php?id=100031055010485`}
                >
              ...
              <div className={iconDivClasses}>
                <Link
                  target="_blank"
                  to={"https://www.linkedin.com/in/manish-tamang-22bb2225a/"}
                >
                  {" "}
                  <FaLinkedin className="hover:text-blue-600 w-6 h-6" />
                </Link>
              </div>
              <div className={iconDivClasses}>
