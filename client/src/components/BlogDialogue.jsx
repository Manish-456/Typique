...
try {
  ...
  return (
    <div className={` p-2`}>                                                                                                                                                                    
   <div className='p-2'>
   <h1> Do you  really want to delete <span className=' text-blue-500'>"{title}"</span>? </h1>
    <div className='flex justify-end mr-4 mt-4 gap-10'>
        <p onClick={handleDeleteBlog} className='text-red-500 cursor-pointer'>
          Yes
        </p>
        <p className='text-green-500 cursor-pointer' onClick={() => setOpenDialogue(false)}>No</p>
        </div>
   </div>
    </div>
  )
